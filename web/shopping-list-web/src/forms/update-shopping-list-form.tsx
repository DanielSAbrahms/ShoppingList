...
export default function NewShoppingListForm(props: NewShoppingListFormProps) {
    ...
    useEffect(() => {
        ...
        dispatch(setCurrentListForEdit(props.shoppingList));
        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, []);

    const { newListState, allProductsState, productsNotInListState } =
        useSelector((state: RootReducerProps) => ({
            newListState: state.editListState.shoppingListForEdit,
            allProductsState: state.editListState.allProducts,
            productsNotInListState: state.editListState.productsNotInList,
        }));
